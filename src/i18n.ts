...
const zh: Translations = {
	...
	'model.pricing.periodRemaining': '剩余 {0}',
	'model.pricing.duration.hourMinute': '{0} 时 {1} 分',
	'model.pricing.duration.hourMinutes': '{0} 时 {1} 分',
	'model.pricing.duration.hoursMinute': '{0} 时 {1} 分',
	'model.pricing.duration.hoursMinutes': '{0} 时 {1} 分',
	'model.pricing.duration.hour': '{0} 时',
...
const en: Translations = {
	...
	'model.pricing.periodRemaining': '{0} remaining',
	'model.pricing.duration.hourMinute': '{0} hour {1} minute',
	'model.pricing.duration.hourMinutes': '{0} hour {1} minutes',
	'model.pricing.duration.hoursMinute': '{0} hours {1} minute',
	'model.pricing.duration.hoursMinutes': '{0} hours {1} minutes',
	'model.pricing.duration.hour': '{0} hour',
