...
<p align="center">
  <a href="https://marketplace.visualstudio.com/items?itemName=Vizards.deepseek-v4-for-copilot"><img src="https://img.shields.io/badge/VS%20Code-Install%20Extension-blue?logo=visualstudiocode&style=for-the-badge" alt="在 VS Code 中安装"></a>
  <a href="https://marketplace.visualstudio.com/items?itemName=Vizards.deepseek-v4-for-copilot"><img src="https://vsmarketplacebadges.dev/version-short/Vizards.deepseek-v4-for-copilot.svg?style=for-the-badge" alt="版本"></a>
  <a href="https://marketplace.visualstudio.com/items?itemName=Vizards.deepseek-v4-for-copilot"><img src="https://vsmarketplacebadges.dev/installs-short/Vizards.deepseek-v4-for-copilot.svg?style=for-the-badge" alt="安装量"></a>
</p>
...
<p align="center">
  <img src="resources/screenshots/01-picker.png" alt="DeepSeek V4 Pro 和 Flash 出现在 Copilot Chat 模型选择器中，带有思考模式（无 / 标准 / 深度）下拉菜单" width="800">
</p>
...
- **不是替换 Copilot，而是增强它。** 没有新的侧边栏，没有新的聊天界面需要学习。只是在已用的模型选择器中多了一个选项。
...
1. 从 VS Code 扩展市场安装
2. 通过命令面板（`Cmd+Shift+P`）运行 **DeepSeek: 设置 API Key**
3. 粘贴你的 Key 或兼容的 provider token（官方 DeepSeek Key 通常以 `sk-` 开头）
4. 打开 Copilot Chat，点击模型选择器，选择 **DeepSeek V4 Pro** 或 **DeepSeek V4 Flash**
5. 搞定——开始聊天
